...
// use reduce() to count the number of total contributions by summing the backers property
...
const gameWord = GAMES_JSON.length === 1 ? "game" : "games";
const descriptorString = ` A total of ${totalRaised.toLocaleString()} has been raised for ${
  GAMES_JSON.length
} ${gameWord}. There ${
  numUnfunded === 1 ? "is" : "are"
} ${numUnfunded} unfunded ${gameWord}.`;

// create a new DOM element containing the template string and append it to the description container
const descriptorElement = document.createElement("p");
descriptorElement.innerHTML = descriptorString;
descriptionContainer.appendChild(descriptorElement);
